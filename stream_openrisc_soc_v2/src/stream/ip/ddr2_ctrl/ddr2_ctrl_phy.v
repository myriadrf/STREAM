...
module ddr2_ctrl_phy (
	...
	ddr2_ctrl_phy_alt_mem_phy	ddr2_ctrl_phy_alt_mem_phy_inst(
	...
	defparam
		ddr2_ctrl_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		ddr2_ctrl_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr2_ctrl_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr2_ctrl_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ddr2_ctrl_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr2_ctrl_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ddr2_ctrl_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6906,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6906 ps",
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1106,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1024,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr2_ctrl_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		ddr2_ctrl_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ddr2_ctrl_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr2_ctrl_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ddr2_ctrl_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2_ctrl_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_mhz" value="144.8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="144.8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "pll_ref_clk_mhz" value="30.72"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_if_clk_ps_label" value="(6906 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "speed_grade" value="7"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "dedicated_memory_clk_phase" value="0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "pll_ref_clk_ps_label" value="(32552 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="winbond_w9751g6kb25"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_ctrl_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_ctrl_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_ctrl_phy_alt_mem_phy_seq_wrapper;+ddr2_ctrl_phy_alt_mem_phy_reconfig;+ddr2_ctrl_phy_alt_mem_phy_pll;+ddr2_ctrl_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/olof/code/or1k/staging/stream_franck/ip/ddr2_ctrl/ddr2_ctrl_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_ctrl_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
