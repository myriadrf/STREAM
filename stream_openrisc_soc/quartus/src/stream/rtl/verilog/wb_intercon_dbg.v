...
wb_mux
  #(.num_slaves (2),
    ...
    .MATCH_MASK ({32'h80000000, 32'hffffff80}))
 wb_mux_or1k_i
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_ibus_adr_o, wb_rom0_adr_o}),
    .wbs_dat_o ({wb_ibus_dat_o, wb_rom0_dat_o}),
    .wbs_sel_o ({wb_ibus_sel_o, wb_rom0_sel_o}),
    .wbs_we_o  ({wb_ibus_we_o, wb_rom0_we_o}),
    .wbs_cyc_o ({wb_ibus_cyc_o, wb_rom0_cyc_o}),
    .wbs_stb_o ({wb_ibus_stb_o, wb_rom0_stb_o}),
    .wbs_cti_o ({wb_ibus_cti_o, wb_rom0_cti_o}),
    .wbs_bte_o ({wb_ibus_bte_o, wb_rom0_bte_o}),
    .wbs_dat_i ({wb_ibus_dat_i, wb_rom0_dat_i}),
    .wbs_ack_i ({wb_ibus_ack_i, wb_rom0_ack_i}),
    .wbs_err_i ({wb_ibus_err_i, wb_rom0_err_i}),
    .wbs_rty_i ({wb_ibus_rty_i, wb_rom0_rty_i}));
