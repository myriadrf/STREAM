...
module ddr2_ctrl (
	...
	ddr2_ctrl_controller_phy	ddr2_ctrl_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr2_ctrl_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_ctrl_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr2_ctrl_phy_alt_mem_phy_seq.vhd,ddr2_ctrl_phy_alt_mem_phy_seq_wrapper.vhd,ddr2_ctrl_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "native" value="verilog"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_ctrl_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_ctrl_alt_mem_phy_seq_wrapper;+ddr2_ctrl_alt_mem_phy_reconfig;+ddr2_ctrl_alt_mem_phy_pll;+ddr2_ctrl_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/olof/code/or1k/staging/stream_franck/ip/ddr2_ctrl/ddr2_ctrl_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_ctrl_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
