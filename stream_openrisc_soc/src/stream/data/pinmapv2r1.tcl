...
#set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to gpio0_io[7]
...
#set_location_assignment PIN_B20 -to gpio0_io[7]
...
set_location_assignment PIN_G14 -to eth0_mdc_pad_o
set_location_assignment PIN_E13 -to eth0_md_pad_io
set_location_assignment PIN_A20 -to eth0_rst_n_o

###########################################
#FX3 Interface
###########################################
set_location_assignment PIN_J4 -to fx3_spi_cs
